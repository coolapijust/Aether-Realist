...
func (b *BrutalSender) OnCongestionEventEx(priorInFlight congestion.ByteCount, eventTime congestion.Time,
...
func (b *BrutalSender) debugPrint(format string, a ...any) {
	log.Printf("[BrutalCC] %s", fmt.Sprintf(format, a...))
}
