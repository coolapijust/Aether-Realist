...
// SetCongestionControl sets the congestion control algorithm.
// It can only be called once the handshake has completed.
func (c *Conn) SetCongestionControl(sa congestion.SendAlgorithm) {
	c.sentPacketHandler.SetCongestionControl(sa)
}
